            ...
            {isOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                    ...
                    <motion.div
                        ...
                        className={cn(
                            "relative w-full max-w-2xl glass p-8 md:p-12 shadow-2xl border border-white/10 z-[110] overflow-hidden",
                            className
                        )}
                        role="dialog"
                        aria-modal="true"
                        ...
                        <div className="relative z-10 space-y-8">
                            <header className="flex items-start justify-between gap-4">
                                <div className="space-y-1">
                                    {title && (
                                        <h2 id="modal-title" className="text-2xl font-black technical tracking-[0.2em] uppercase">
                                            {title}
                                        </h2>
                                    )}
                                    {description && (
