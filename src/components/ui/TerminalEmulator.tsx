...
export function TerminalEmulator({
    ...
    return (
        <div className="w-full flex flex-col rounded-md border border-white/10 bg-[#0a0a0a] shadow-2xl overflow-hidden font-mono text-sm">
            {/* Header */}
            ...
            >
                {logs.length === 0 && (
                    <div className="opacity-30">Initializing substrate connection...</div>
                )}
                ...
                {logs.map((log) => (
                    <motion.div
                        ...
                        className="mb-1 leading-relaxed flex gap-3"
                    >
                        {log.timestamp && (
