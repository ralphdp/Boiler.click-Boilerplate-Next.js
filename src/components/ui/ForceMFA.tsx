...
export function ForceMFA({ locale }: { locale: string }) {
    ...
    return (
        <div className="fixed inset-0 z-[9999] flex flex-col items-center justify-center text-center p-8 text-white">
            ...
            <div className="z-10 bg-[#050505] border border-[var(--accent)]/30 p-10 max-w-lg w-full rounded-2xl shadow-[0_0_100px_rgba(0,230,118,0.1)] relative">
                ...
                <h1 className="text-2xl font-bold tracking-normal text-[var(--accent)] mb-4">SECURITY MANDATE</h1>
                <p className="text-[10px] text-white/50 tracking-normal] mb-8 leading-relaxed">
                ...
                <Button as={Link} href={`/${locale}/dashboard/settings?tab=security`} variant="solid-accent" className="w-full flex justify-center py-4">
