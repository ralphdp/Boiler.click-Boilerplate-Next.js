...
import { getSEOMatrix, updateSEORoute } from "@/core/actions/system";
                                        ...
                                        <td className="p-4 text-right">
                                            <div className="flex items-center justify-end gap-2">
                                                <Button
                                                    ...
                                                    className="px-4 py-2 bg-white/5 border border-white/10 hover:border-white/30 text-[9px] font-black uppercase tracking-widest transition-all h-auto"
