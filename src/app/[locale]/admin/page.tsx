...
export default function AdminPage() {
    ...
    const [broadcastUrgency, setBroadcastUrgency] = useState<'INFO' | 'WARN' | 'CRIT'>('INFO');
    ...
    useEffect(() => {
        ...
        getGlobalOverrides()
            .then(res => {
                ...
                setBroadcastUrgency(res.broadcastUrgency as any || 'INFO');
                ...
                <div className="flex flex-col md:flex-row gap-6 items-start w-full">
                    ...
                    <div className="flex-1 w-full min-w-0">
                        <AnimatePresence mode="wait">
                            ...
                            {tab === "broadcast" && <AdminBroadcast t={t} broadcastMessage={broadcastMessage} setBroadcastMessage={setBroadcastMessage} broadcastUrgency={broadcastUrgency} setBroadcastUrgency={setBroadcastUrgency} />}
