        ...
        <main className="min-h-screen pt-24 pb-12 px-6 flex items-center justify-center bg-[radial-gradient(circle_at_top,var(--accent)/0.05,transparent)]">
            <div className="w-full max-w-4xl flex flex-col items-center gap-8">
                <div className="text-center space-y-2">
                    <h1 className="text-3xl font-bold tracking-normal] text-[var(--accent)]">Sovereign Terminal</h1>
                ...
                <div className="text-[10px] text-white/20 tracking-normal flex items-center gap-4">
