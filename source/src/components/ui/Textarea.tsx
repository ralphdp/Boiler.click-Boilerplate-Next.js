            ...
            <div className="w-full space-y-2 group">
                ...
                <div className="relative">
                    <textarea
                        ref={ref}
                        className={cn(
                            "w-full bg-black/50 border border-white/5 p-4 text-sm technical tracking-widest focus:border-accent/40 focus:outline-none transition-all placeholder:text-white/5 resize-y min-h-[100px]",
