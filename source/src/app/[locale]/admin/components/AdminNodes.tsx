...
import { exportSovereignNodesCSV, bulkUpdateNodeRoles, bulkUpdateNodeStatus } from "@/core/actions/admin";
                        ...
                        >
                            ...
                            <div className="flex flex-wrap gap-2">
                                <button
                                    ...
                                    className="bg-[var(--accent)]/20 hover:bg-[var(--accent)]/40 border border-[var(--accent)]/50 px-4 py-2 text-[9px] font-black uppercase tracking-widest text-[var(--accent)] transition-colors flex items-center gap-2"
                                >
                                    <ShieldCheck size={12} /> Escalate to Root
                                </button>
                                <button
                                    onClick={() => handleBulkRoleUpdate("USER")}
                                    className="bg-white/5 hover:bg-white/10 border border-white/10 px-4 py-2 text-[9px] font-black uppercase tracking-widest text-white/70 transition-colors"
                                >
                                    Downgrade to User
                                </button>
                                ...
                                <button
                                    ...
                                    className="bg-red-500/10 hover:bg-red-500/20 border border-red-500/30 px-4 py-2 text-[9px] font-black uppercase tracking-widest text-red-500 transition-colors flex items-center gap-2"
                                >
                                    <UserX size={12} /> Neutralize Nodes
                                </button>
                                <button
                                    onClick={() => handleBulkStatusUpdate(false)}
                                    className="bg-green-500/10 hover:bg-green-500/20 border border-green-500/30 px-4 py-2 text-[9px] font-black uppercase tracking-widest text-green-500 transition-colors"
                                >
