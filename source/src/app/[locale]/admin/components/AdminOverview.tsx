        ...
        >
            ...
            <div className="bg-black/40 border border-white/5">
                <div className="p-4 border-b border-white/5 bg-white/5 flex justify-between items-center">
                    ...
                    <button onClick={() => setTab("audit")} className="text-[10px] text-[var(--accent)] hover:text-white transition-colors tracking-widest uppercase font-bold">{t.admin.overview.viewAll}</button>
                </div>
